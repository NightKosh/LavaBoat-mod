...
public class EntityPetBoat extends Entity {
    ...
    protected void findAndMountPet() {
        AxisAlignedBB mountArea = AxisAlignedBB.fromBounds(this.boat.getEntityBoundingBox().minX - 7, this.boat.getEntityBoundingBox().minY - 7, this.boat.getEntityBoundingBox().minZ - 7,
