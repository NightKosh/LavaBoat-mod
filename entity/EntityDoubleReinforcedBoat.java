...
public class EntityDoubleReinforcedBoat extends EntityDoubleBoat {
    ...
    public void onUpdate() {
        ...
        for (int i = 0; i < b0; ++i) {
            double d1 = this.boundingBox.minY + (this.boundingBox.maxY - this.boundingBox.minY) * i / b0 - 0.85;
            double d2 = this.boundingBox.minY + (this.boundingBox.maxY - this.boundingBox.minY) * (i + 1) / b0 - 0.85;
            ...
            if (!this.worldObj.isRemote) {
                ...
                if (list != null && !list.isEmpty()) {
                    for (l = 0; l < list.size(); ++l) {
                        ...
                        if (entity != this.riddenByEntity && entity.canBePushed() && entity instanceof EntityDoubleReinforcedBoat) {
